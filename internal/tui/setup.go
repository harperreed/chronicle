// ABOUTME: Interactive TUI wizard for configuring chronicle's storage backend.
...
// defaultDataDir returns the default XDG data directory for chronicle.
func defaultDataDir() string {
	...
	return filepath.Join(dataDir, "chronicle")
}
...
func (m SetupModel) View() string {
	...
	b.WriteString("\n")
	b.WriteString(brandStyle.Render("   CHRONO BLASTER 3000"))
	b.WriteString(titleStyle.Render(" - Setup"))
	b.WriteString("\n\n")
	b.WriteString("Configure chronicle storage backend.\n\n")
	...
	case StepDone:
		b.WriteString(successStyle.Render("✓ Configuration ready!"))
		b.WriteString("\n\n")
		_, _ = fmt.Fprintf(&b, "  Backend:        %s\n", m.inputs[0].Value())
		_, _ = fmt.Fprintf(&b, "  Data directory:  %s\n", m.inputs[1].Value())
		b.WriteString("\n")
	}

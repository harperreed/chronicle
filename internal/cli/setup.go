// ABOUTME: Cobra command for interactive chronicle storage configuration.
...
import (
	...
	"github.com/harper/chronicle/internal/tui"
)

var setupCmd = &cobra.Command{
	Use:   "setup",
	Short: "Configure chronicle storage backend",
